...
const PROMPT_TEXT_PRESETS = [
  ...
  'Soulful vocals with jazzy chords',
  'Intricate percussion with shakers',
  'Relaxed tempo house',
  'Organic percussive rhythms',
  'Log drums and pads',
  'Melodic piano riffs',
  'Chill house grooves',
  'Atmospheric synths',
...
// FIX: The class 'WeightSlider' must extend 'LitElement' to be a custom element and use its features.
...
// FIX: The class 'IconButton' must extend 'LitElement' to be a custom element and use its features.
...
// FIX: The class 'ToastMessage' must extend 'LitElement' to be a custom element and use its features.
...
// FIX: The class 'PromptController' must extend 'LitElement' to be a custom element and use its features.
...
// FIX: The class 'SettingsController' must extend 'LitElement' to be a custom element and use its features.
...
// FIX: The class 'PromptDj' must extend 'LitElement' to be a custom element and use its features.
class PromptDj extends LitElement {
  ...
  private audioContext = new ((window as any).AudioContext ||
